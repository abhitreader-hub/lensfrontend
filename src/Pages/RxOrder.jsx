            ...
            <table className="min-w-full table-fixed divide-y divide-slate-200">
              <thead className="bg-gradient-to-r from-blue-50 to-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="w-[150px] text-center py-4 px-3 text-slate-700 font-bold text-sm">Used in(per)</th>
                  <th className="w-[170px] text-center py-4 px-3 text-slate-700 font-bold text-sm">Charge Station</th>
                  <th className="w-[170px] text-center py-4 px-3 text-slate-700 font-bold text-sm">Place ord.</th>
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((o, i) => (
                    <tr key={o.id} className="hover:bg-slate-50 transition-colors duration-150 group text-sm">
                      ...
                      <td className="min-w-[150px] text-center py-3 px-3 text-slate-700 align-top">{o.placeOrder || "-"}</td>
